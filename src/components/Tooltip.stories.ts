...
/** Basic tooltip - hover over the button to see it appear after 300ms */
export const Default = {
  args: { text: 'Download calendar file (.ics)', triggerText: 'Hover me' },
};

/** Tooltip with longer text that wraps within the max width (240px) */
export const LongText = {
  args: { text: 'This tooltip has a much longer text to demonstrate how it wraps within the max width constraint', triggerText: 'Long tooltip' },
};

/** Disabled tooltips should not appear when hovering */
export const Disabled = {
  args: { text: 'You should not see this', disabled: true, triggerText: 'Disabled (no tooltip)' },
};

/** Tooltip on dark background surface */
export const OnDarkBackground = {
  args: { text: 'Tooltip on dark surface', triggerText: 'Hover me' },
  decorators: [
...
export const DarkAndNarrow = {
  args: { text: 'Combined decorators example', triggerText: 'Hover me' },
  decorators: [
